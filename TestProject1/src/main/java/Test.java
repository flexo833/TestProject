...
public class Test {
    public static void main(String[] args) throws InterruptedException {
        ...
        (new WebDriverWait(driver,10))
                .until(ExpectedConditions.presenceOfElementLocated(By.cssSelector("#subtab-AdminCategories > a"))).click();
        ...
        (new WebDriverWait(driver,10))
                .until(ExpectedConditions.presenceOfElementLocated(By.cssSelector("#page-header-desc-category-new_category"))).click();
        logger.afterClickOn(newCategorylink, driver);

        WebElement nameInputField = driver.findElement(By.cssSelector("#name_1"));
        (new WebDriverWait(driver,10))
                .until(ExpectedConditions.presenceOfElementLocated(By.cssSelector("#name_1"))).sendKeys("TestCategoryPoliannik");
        ...
        WebElement filter = driver.findElement(By.cssSelector("#table-category > thead > tr:nth-child(1) > th:nth-child(3) > span > a:nth-child(1) > i"));
        filter.click();
